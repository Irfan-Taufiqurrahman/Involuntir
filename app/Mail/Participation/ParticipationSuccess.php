...
class ParticipationSuccess extends Mailable
{
    ...
    {
        return $this->subject('Pembayaran aktivitas berhasil! ' . $this->participation->activity->judul_activity)
            ->from('noreply@involuntir.com', 'Involuntir')
            ->view('emails.participation.berhasil')
            ->with([
